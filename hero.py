    ...
    def __init__(self):
        ...
        self.idle_frames = [
            pygame.transform.scale(
                pygame.image.load(f"./assets/hero/hero_idle_{i}.png"),
        ...
        self.bk_idle_frames = [
            pygame.transform.scale(
                pygame.transform.flip(
                    pygame.image.load(f"./assets/hero/hero_idle_{i}.png"), True, False
                ),
                (self.width, self.height),
            )
            for i in range(4)
        ...
        self.run_frames = [
            pygame.transform.scale(
                pygame.image.load(f"./assets/hero/hero_run_{i}.png"),
                (self.width, self.height),
            )
            for i in range(8)
        ]
        self.bk_run_frames = [
            pygame.transform.scale(
                pygame.transform.flip(
                    pygame.image.load(f"./assets/hero/hero_run_{i}.png"), True, False
                ),
                (self.width, self.height),
            )
            for i in range(8)
        ]
        self.attack_frame = pygame.transform.scale(
            pygame.image.load(f"./assets/hero/attack_2.png"), (self.width, self.height)
        )
        self.bk_attack_frame = pygame.transform.scale(
            pygame.transform.flip(
                pygame.image.load(f"./assets/hero/attack_2.png"), True, False
            ),
            (self.width, self.height),
        )

        self.take_hit_frame = pygame.transform.scale(
            pygame.image.load(f"./assets/hero/hit.png"), (self.width, self.height)
        )
        self.bk_take_hit_frame = pygame.transform.scale(
            pygame.transform.flip(
                pygame.image.load(f"./assets/hero/hit.png"), True, False
            ),
            (self.width, self.height),
        )

        self.jump_frame = pygame.transform.scale(
            pygame.image.load(f"./assets/hero/hero_jump_0.png"),
            (self.width, self.height),
        )
        self.bk_jump_frame = pygame.transform.scale(
            pygame.transform.flip(
                pygame.image.load(f"./assets/hero/hero_jump_0.png"), True, False
            ),
            (self.width, self.height),
        )
